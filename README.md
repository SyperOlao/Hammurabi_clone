# #1: Hammurabi
## Оригинальные фичи реализованной версии
- Добавлена оригинальная музыка при каждом ходе\чуме\победе\проигрыше
- Добавлена механика инспектора и мертвых душ.
  - Инспектор приходит на 4 год, если количество смертей превышает 20
  - Ему можно дать взятку в размере некоторого числа мертвых душ
  - Если не дать ему взятку, то он заберет 25% земли и пшеницы
## Скриншоты игры
Начало
![img.png](img.png)
Конец хода
